...
export default function Civilizacion() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.title}>??? Civilización</Text>
      <Text style={styles.titleAr}>??? ???????</Text>

      <View style={styles.section}>
        <Text style={styles.sectionTitle}>?? Importancia de la civilización</Text>
        <Text style={styles.sectionText}>
          La civilización española tiene una rica historia multicultural.
        </Text>
