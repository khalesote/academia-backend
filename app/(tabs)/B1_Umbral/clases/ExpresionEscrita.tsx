...
const TEMAS = [
  {
    es: "Un reto que superaste y cómo lo lograste",
    ar: "تحدٍّ تغلبت عليه وكيف فعلت ذلك"
  },
  {
    es: "Describe una meta que tienes para el futuro",
    ar: "صف هدفًا لديك للمستقبل"
  },
  {
    es: "Habla sobre una experiencia inolvidable de viaje",
    ar: "تحدث عن تجربة سفر لا تُنسى"
  },
  {
    es: "Tu opinión sobre el uso de la tecnología en la vida diaria",
    ar: "رأيك في استخدام التكنولوجيا في الحياة اليومية"
  },
  {
    es: "Una tradición importante en tu cultura",
    ar: "تقليد مهم في ثقافتك"
  }
];
...
export default function ExpresionEscrita() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
      <TouchableOpacity style={styles.backButton} onPress={() => router.push('/B1_Umbral')}>
        <Text style={styles.backButtonText}>Volver a unidades</Text>
      </TouchableOpacity>
      <Text style={styles.title}>Expresión Escrita - B1</Text>
